...
const SkeletonCard = () => (
    <div className="bg-white rounded-sm p-4 md:p-6 flex flex-col h-full animate-pulse border border-gray-100 shadow-sm">
        <div className="w-full aspect-[4/5] bg-gray-200 rounded-sm mb-6"></div>
