    ...
    return (
        <div className="min-h-screen">
            <div className="relative bg-white pt-24 pb-20 overflow-hidden">
                {/* Magical Background Shade covering top */}
                            ...
                            <div className="flex flex-col md:flex-row gap-12 lg:gap-20 items-center md:items-start">
                                ...
                                <div className="w-full md:w-5/12 md:pt-4 text-center md:text-left">
                                    ...
                                    <p className="text-gray-600 text-lg md:text-xl mb-6">
                                        We'd love to hear from you. Please fill out the form and we'll get back to you.
                                    </p>

                                    <div className="flex items-center justify-center md:justify-start gap-3 text-[#2f6fe7] font-medium mt-6">
                                        <svg className="w-5 h-5 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                                        </svg>
                                        <a href="mailto:hello@magicwish.in" className="hover:text-blue-800 transition-colors">
                                            hello@magicwish.in
                                        </a>
                                    </div>
                                </div>
                                    ...
                                    <form onSubmit={handleSubmit} className="space-y-5">
                                        <div>
                                            <input
                                                ...
                                                className="w-full bg-white border border-gray-200 rounded-md px-4 py-3.5 text-gray-900 focus:outline-none focus:border-blue-400 focus:ring-1 focus:ring-blue-400 transition-all placeholder-gray-400"
                                            />
                                        </div>
                                        ...
                                        <div>
                                            <textarea
                                                ...
                                                className="w-full bg-white border border-gray-200 rounded-md px-4 py-3.5 text-gray-900 focus:outline-none focus:border-blue-400 focus:ring-1 focus:ring-blue-400 transition-all resize-none placeholder-gray-400"
                                            />
                                        </div>
