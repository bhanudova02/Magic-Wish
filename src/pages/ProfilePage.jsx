            ...
            <section>
                ...
                <div className="p-6 border border-gray-100 rounded-sm space-y-6">
                    ...
                    <div>
                        ...
                        <p className="text-sm font-bold break-all underline decoration-gray-100 underline-offset-4">{customerData?.emailAddress?.emailAddress}</p>
                    </div>
                </div>
            </section>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        {(customerData?.addresses?.edges || []).map(({ node: addr }) => (
                            <div key={addr.id} className="p-6 border border-gray-100 rounded-sm relative group hover:border-black transition-all">
                                ...
                                <div className="mt-4 pt-4 border-t border-gray-50 flex gap-4 text-[9px] font-bold uppercase tracking-widest">
