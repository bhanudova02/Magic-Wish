        ...
        <section id="girls-books" className="pt-14 pb-10 md:pt-20 md:pb-12 bg-white">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="flex justify-between items-end mb-4 border-b border-gray-100 pb-3 px-1">
                    ...
                    <Link to="/books" state={{ selectedGender: 'girl' }} className="hidden md:flex text-purple-600 font-bold hover:text-purple-700 transition items-center gap-1 group">
                ...
                <div className="mt-8 text-center md:hidden">
                    <Link to="/books" state={{ selectedGender: 'girl' }} className="inline-flex text-purple-600 font-bold hover:text-purple-700 transition items-center gap-1 bg-purple-50 px-6 py-3 rounded-full">
