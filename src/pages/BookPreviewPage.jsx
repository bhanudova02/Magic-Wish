...
export default function BookPreviewPage() {
    ...
    useEffect(() => {
        ...
        if (data) {
            ...
            navigate('/books'); // Redirect if no data
        }
        window.scrollTo(0, 0);
    }, [navigate]);
                            ...
                            <div className="relative w-full h-full flex items-center justify-center">
                                {currentSlide === 0 ? (
                                    ...
                                    <div className="relative w-[85%] h-[90%] bg-purple-600 rounded-sm shadow-2xl overflow-hidden group">
                                        ...
                                        <div className="absolute inset-0 bg-cover bg-center opacity-80" style={{ backgroundImage: `url(https://images.unsplash.com/photo-1618519764620-7403abdb0991?q=80&w=1200&h=1200&auto=format&fit=crop)` }}></div>
                                        ...
                                        <div className="relative z-20 h-full flex flex-col items-center justify-center p-8 text-center text-white">
                                            ...
                                            <p className="text-xl md:text-2xl font-bold opacity-90 drop-shadow-md">and the Cosmic Journey</p>
                                        </div>
